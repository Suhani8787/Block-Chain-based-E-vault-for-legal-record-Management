# Decentralized documents Upload and Sharing

This project facilitates decentralized document upload and sharing on the blockchain using Solidity for the smart contract and React for the front-end interface. It enables users to securely upload document to IPFS (InterPlanetary File System) and share access with specified users through smart contract functionality.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/jatinbaheti07/Blockchain-based-eVault-for-legal-records.git
   ```
